...
<link rel="stylesheet" href="<%= pjName %>/resources/style/stylecss.css" type="text/css">
<script type="text/javascript" src="<%= pjName %>/resources/js/jquery-1.7.1.js"></script>
<script  src="<%= pjName %>/resources/js/js_userinput.js"></script>
</head>
